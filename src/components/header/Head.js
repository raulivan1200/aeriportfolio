...
function isIOS() {
  ...
  return (
    ...
    (isMac && navigator.userAgent.includes('MacIntel') && navigator.userAgent.includes('M1')) ||
    (isMac && navigator.userAgent.includes('MacIntel') && navigator.userAgent.includes('Apple M2')) ||
    (isMac && navigator.userAgent.includes('M1') && navigator.userAgent.includes('MacBook Air')) ||
    (isMac && navigator.userAgent.includes('M1') && navigator.userAgent.includes('MacBook Pro')) ||
    (isMac && navigator.userAgent.includes('M1') && navigator.userAgent.includes('Mac mini')) ||
    (isMac && navigator.userAgent.includes('M1') && navigator.userAgent.includes('iMac'))
  );
}
